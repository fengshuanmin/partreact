...
//登陆
export const login = (params) => post({url:config.URL_login,params});

//获取验证码
export const get_verification_code = (params) => get({url:config.URL_get_verification_code+params.mobile});

//查询公司

export const queryCompany = (params) => get({url:config.URL_vendor_account_query_company,params})