...
import {URL_Price_cube} from '../../utils/net/Url';
import $ from "jquery";




class PartsPriceCube extends Component{
    constructor(props){
        super(props)
        this.state={
    ...
    orderdetail(){
        this.props.history.push('/app/PartsPriceCube.js')
    }
    ...
    render() {
        return (
            <div style={{marginTop:40,minWidth:800,maxWidth:1200}}>
                <Card style={{minHeight:1000}}>
                    <div ><h1 className="h1">价格立方体</h1></div>
                    <div>
                        <div style={{
                            width: '40%',
                            marginLeft: '1%',
                        ...
                        <input className="spani" placeholder='车架号' onChange={this.pjevent} type="text" value={this.state.pjId}/>
                        <Button type="primary">展示</Button>
                    </div>
