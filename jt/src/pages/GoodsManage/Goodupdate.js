...
export default class  Goodupdate extends Component{
    ...
    componentDidMount(){
        ...
        $.ajax({
            url:URL_api_parts_sku_info+'/'+goodsId,
            type:'get',
            headers:{appToken:USER_INFO_GET()&&USER_INFO_GET().appToken||''},
            success:(res)=>{
                console.log(res)
                console.log(res.infoMap.partsSku)
                if(res.code==0){
                    // var {partList={}}=this.state
                    // partList=res.partsSku
                    this.setState({
                ...
                <div style={{width:'100%',float:'left'}}>
                    <div style={{
                        ...
                        <div className="spantotal" style={{position:'relative'}}>
                            <span className="spanlabel">配件名称</span>
                        ...
                        <div className="spantotal">
                            <span className="spanlabel">零件号</span>
                        ...
                        <div className="spantotal">
                            <span className="spanlabel">配件品质</span>
                    ...
                    <div style={{
                        ...
                        <div style={{textAlign:'right',float:'left',marginTop:'70px',width:'100%'}}>
                            <Button type="primary" onClick={this.loadcomfir}>修改并新建</Button>
                            <Button type="primary" onClick={this.comfir}>修改</Button>
